    ...
    <div>
      <main className={ props.open ?  styles["menu-active"] : styles.menu}>
        <section className={styles["menu-content"]} >
          <div onClick={() => props.setOpen(prevState => !prevState)} className={ props.open ?  styles["burger-close-btn"] : styles["burger-close-btn-hidden"]} >
          ...
          {items.map(item =>
            item.hasOwnProperty("link")
              ...
              <section style={{width:"100%"}} >
                <Link className={styles["menu-item"]} href={item.link}>{item.text}</Link>
              ...
              <section style={{width:"100%"}} >
                ...
                <div className={styles["menu-children-container"]} >
                  {item.children.map(child =>
                    <Link className={styles["menu-child"]} href={child.link}>{child.text}</Link>
                  )}
                </div>
                <hr className={styles["menu-hr"]} />
              </section>
